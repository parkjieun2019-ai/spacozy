...
export default function ProgramsPage() {
  return (
    <>
            ...
            <Container>
              <div className="grid gap-10 md:grid-cols-2 md:gap-16">
                ...
                <div>
                  ...
                  <h2 className="font-serif text-[1.7rem] leading-[1.5] text-green md:text-[2.2rem]">{p.name}</h2>
                  <p className="mt-6 text-[1.05rem] leading-[1.95] text-ink/85">{p.intro}</p>

                  <dl className="mt-8 grid grid-cols-2 divide-x divide-sand border-y border-sand py-5 text-center">
                    <div>
                      <dt className="text-sm text-greige">소요 시간</dt>
                      <dd className="mt-1 font-serif text-[1.15rem] text-green">{p.durationLabel}</dd>
                    </div>
                    <div>
                      <dt className="text-sm text-greige">가격</dt>
                      <dd className="mt-1 font-serif text-[1.15rem] text-green">{formatPrice(p.price)}</dd>
                    </div>
                  </dl>
      ...
      <section className="bg-green py-16 text-center text-ivory md:py-20">
        <Container>
