      ...
      <section className="py-16 md:py-24">
        <Container className="grid gap-6 md:grid-cols-2">
          ...
          <article className="flex flex-col border border-sand/80 bg-white/40 p-9 md:p-12">
            ...
            <ul className="mt-7 space-y-5">
              {[
                ...
                <li key={t} className="flex gap-4">
                  <span className="mt-2.5 h-2 w-2 shrink-0 rounded-full bg-wood" />
                  <div>
                    <p className="font-serif text-[1.12rem] text-green">{t}</p>
            ...
            <p className="mt-8 text-greige">정액권 종류와 금액은 방문 상담 시 자세히 안내해 드립니다.</p>
            <div className="mt-auto pt-10">
