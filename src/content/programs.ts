...
export const programs: Program[] = [
  {
    ...
    intro:
      "굳어 있는 몸의 결과 순환의 길을 찾아, 쌓인 붓기와 피로를 가볍게 비워냅니다. 20년 숙련된 손끝이 그날의 컨디션에 맞춰 압을 조절하는 스파코지의 시그니처 전신 수기 관리입니다.",
    steps: [
      ...
      { title: "복부 온열 케어", desc: "복부를 따뜻하게 감싸 몸의 중심부터 편안하게 데워줍니다." },
      { title: "두피 이완 마무리", desc: "굳은 두피를 부드럽게 풀어주는 이완 케어와 스트레칭." },
    ],
  ...
  },
  {
    ...
    intro:
      "목과 데콜테를 먼저 풀어준 뒤, 얼굴의 결을 따라 부드럽게 이완해 탄력 있는 선을 위한 관리를 더합니다. 억지로 당기지 않고, 본연의 우아한 얼굴선을 정돈합니다.",
    steps: [
      { title: "두피 & 데콜테 오픈", desc: "얼굴로 이어지는 목과 데콜테를 먼저 풀어주는 순환 케어." },
